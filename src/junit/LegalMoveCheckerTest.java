...
/**
 * Test class forLegalMoveChecker, checks legal moves, captures, if a stone is
 * occupied and the superKo rule.
 */
public class LegalMoveCheckerTest {
	...
	@Test
	public void FreeB() {
		byte b[][] = { { 0, 0, 0, 0 }, { 0, 1, 0, 0 }, { 1, 2, 0, 1 },
				{ 0, 1, 1, 0 } };
		Board board = new Board(b);
		boolean result;
		for (int i = 0; i < board.getWidth(); i++) {
	...
	@Test
	public void FreeW() {
		byte b[][] = { { 0, 0, 0, 0 }, { 1, 1, 0, 0 }, { 0, 2, 0, 0 },
				{ 0, 1, 1, 0 } };
		Board board = new Board(b);
		boolean result;
		for (int i = 0; i < board.getWidth(); i++) {
	...
	public void Capture() {
		byte b[][] = { { 0, 0, 0, 0 }, { 0, 1, 1, 0 }, { 1, 2, 0, 1 },
				{ 0, 1, 1, 0 } };
		byte b1[][] = { { 0, 0, 0, 0 }, { 0, 1, 1, 0 }, { 1, 0, 1, 1 },
				{ 0, 1, 1, 0 } };
		boolean result;
		Board board = new Board(b);
	...
	@Test
	public void SuperKo() {
		byte b[][] = { { 0, 0, 0, 0 }, { 1, 1, 2, 2 }, { 1, 0, 1, 2 },
				{ 1, 1, 2, 2 } };
		boolean result;
		Board board = new Board(b);

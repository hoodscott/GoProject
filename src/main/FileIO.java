...
public final class FileIO {
    ...
    public static void writeLog(String text) {
        writeLog(text, RELATIVEPATH + DEFLOGOUTPUT + DEFLOGNAME);
    }
    ...
    public static ArrayList<String> readFile(String path) {
        ...
        try {
            ...
            System.err.println("ERROR: The program could not read the file at: " + path);
        } finally {
            try {
                if (reader != null) {
                    reader.close();
                ...
                System.err.println("ERROR: There was an error closing the reading stream.");
            }
        }
        return rawInput;
    }
    ...
    public static void writeFile(String output, String path) {
        ...
        try {
            ...
            System.err.println("ERROR: The program could not write the file to: " + p);
        } finally {
            ...
            try {
                ...
                System.err.println("ERROR: There was an error closing the writing stream.");
            }
        }
    }

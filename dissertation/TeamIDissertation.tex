...
Upon having established the requirements, the first developmental step towards a final problem solver was enabling the representation of a board and the ability to make exclusively legal moves on it. Further, a board loading and saving mechanism, as well as a command-line based UI, were also created during the first stage of design and implementation. These components allowed for easier interaction, testing and future development. Following the implementation of each of these features, the basic interaction structure of the program can be seen in Figure 3.1. Notably, each of these features were implemented as a Java class, designed to function as fairly independent components.
